...
//Variaveis globais colocadas para funcionamento das funções
...
//Função usada para criar o Socket 
...
struct sockaddr_in cria_endereco_destino(char *destino, int porta_destino){
      struct sockaddr_in servidor;	// Endereco do servidor que inclui o ip e a porta 
      struct hostent *dest_internet;	// Endereco destino com um formato proprio 
      struct in_addr dest_ip;	 	// Endereco destino com um formato ip numerico 
...
/****---------- FUNÇÕES PARA UTILIZAÇÃO DO SOCKET ----------****/
